(() => {
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: a } = t.navigation,
          r = s.target;
        if (t.params.navigation.hideOnClick && !x(r).is(a) && !x(r).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function me(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (a.find(he(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          a.find(he(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
  ...
  window.addEventListener("load", function (e) {
    ve(),
      ...
      document.querySelector(".clinic__slider") &&
        new ce(".clinic__slider", {
          modules: [ue, me, fe, ge],
          observer: !0,
          observeParents: !0,
          autoHeight: !0,
      ...
      document.querySelector(".reviews__slider") &&
        new ce(".reviews__slider", {
          ...
          breakpoints: {
            ...
            680: { slidesPerView: 2, spaceBetween: 10, slidesPerGroup: 2 },
            992: { slidesPerView: 3, spaceBetween: 10, slidesPerGroup: 3 },
          },
          on: {
            init: function (e) {
  ...
  const be = document.querySelectorAll('a[href*="#"]');
  for (let e of be)
  ...
  let ye = [45.06644391379556, 38.966570593254076];
  ymaps.ready(function () {
    let e = new ymaps.Map("map-test", { center: ye, zoom: 17 }),
    ...
    document.querySelectorAll(".menu__list li a").forEach((e) =>
